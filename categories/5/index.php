...
<head>
  ...
  <title>Limited Edition | Categories | Nexus</title>
</head>
<body>
  <header>
    <div class="btn-menu">
      ...
      <a class="header--logo" href="./">
        <img src="../../assets/icons/logo.png" alt="Logo de Nexus Store"><p>Edición Limitada</p>
      </a>
    </div>
  ...
  <main>
    <aside class="main__category">
      <img class="category--avatar" src="../asset/limitedEdition-cat.jpg" alt="Foto de la categoría Edicion limitada">
      <h1 class="category--title">Edicion limitada</h1>
      <p class="category--description">Encuentra aquí tus EDICIONES LIMITADAS de Consolas, videojuegos y accesorios</p>
