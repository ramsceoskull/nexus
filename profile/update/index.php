...
<body>
  <header>
    <div class="btn-menu">
      ...
      <a class="header--logo" href="./">
        <img src="../../assets/icons/logo.png" alt="Logo de Nexus Store"><h1>Mis datos</h1>
      </a>
    </div>
  ...
  <div class="welcome-greeting">
      <h2>Cambia tus datos <?php echo $Nombre?></h2>
    </div>
    <form action="../../private/actualizar_perfil.php" method="post" class="user__data-container">
      <div class="userD">
        <label for="nombre">Nombre:</label><input type="text" name="nombre" id="nombre" value="<?php echo $Nombre?>">
      </div>
      <div class="userD">
        <label for="correo">Correo:</label><input type="email" name="correo" id="correo" value="<?php echo $correo?>">
      </div>
      <div class="userD">
        <label for="contraseña">Contraseña:</label><input type="text" name="contrasenna" id="contraseña" value="<?php echo $cont?>">
      </div>
