...
<head>
  ...
  <link rel="icon" href="../../assets/icons/1x/inventory-black.png">
  <link rel="stylesheet" href="../../theme/global/product.css?ts=<?=time()?>">
...
<body>
  <header>
    <div class="btn-menu">
      ...
      <a class="header--logo" href="">
        <img src="../../assets/icons/logo.png" alt="Logo de Nexus Store"><h2>Nexus Store</h2>
      </a>
    </div>
    <nav class="header__menu">
      <a href="../../home/" class="menu--home">
        <svg fill="currentColor" viewBox="0 0 16 16">
  ...
  <main>
    ...
    ?>
      <section class="product--breakpointT">
        <aside class="aside__product">
          <p class="product--log"><?php echo $estado?> | Productos vendidos</p>
          <h1 class="product--title"><?php echo $nombre?></h1>
          <figure class="product__raiting-container">
            <div class="product__raiting--value">
              <svg fill="currentColor" viewBox="0 0 16 16">
            ...
            <p class="product__raiting--info">~ opiniones</p>
          </figure>
          <figure class="product__img-container">
            <img src="../<?php echo $img?>" alt="">
            <svg fill="currentColor" class="bi bi-zoom-in" viewBox="0 0 16 16">
            ...
            <svg fill="currentColor" class="bi bi-zoom-out" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"></path>
              <path d="M10.344 11.742c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1 6.538 6.538 0 0 1-1.398 1.4z"></path>
        ...
        <section class="product__info-container">
          ...
          <p class="product--refund">
            <svg fill="currentColor" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M8 3a5 5 0 1 1-4.546 2.914.5.5 0 0 0-.908-.417A6 6 0 1 0 8 2v1z"></path>
              <path d="M8 4.466V.534a.25.25 0 0 0-.41-.192L5.23 2.308a.25.25 0 0 0 0 .384l2.36 1.966A.25.25 0 0 0 8 4.466z"></path>
            </svg>Devolución Gratis
          </p>
          <p class="product--refund-info">Tienes 30 días desde que lo recibes.</p>
          <p class="product--security">
            <svg fill="currentColor" class="bi bi-shield-fill-check" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M8 0c-.69 0-1.843.265-2.928.56-1.11.3-2.229.655-2.887.87a1.54 1.54 0 0 0-1.044 1.262c-.596 4.477.787 7.795 2.465 9.99a11.777 11.777 0 0 0 2.517 2.453c.386.273.744.482 1.048.625.28.132.581.24.829.24s.548-.108.829-.24a7.159 7.159 0 0 0 1.048-.625 11.775 11.775 0 0 0 2.517-2.453c1.678-2.195 3.061-5.513 2.465-9.99a1.541 1.541 0 0 0-1.044-1.263 62.467 62.467 0 0 0-2.887-.87C9.843.266 8.69 0 8 0zm2.146 5.146a.5.5 0 0 1 .708.708l-3 3a.5.5 0 0 1-.708 0l-1.5-1.5a.5.5 0 1 1 .708-.708L7.5 7.793l2.646-2.647z"></path>
            </svg>Compra Protegida
          </p>
          <p class="product--security-info">Recibe el producto que esperabas o te devolvemos tu dinero.</p>
          <a href="../../error/" class="product__shop-button now">
            <svg fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
              <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.75.75 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425a.267.267 0 0 1 .02-.022z"></path>
            </svg>Comprar ahora
          </a>
          <a href="../../private/agregar.php?upd=<?php echo $id?>" class="product__shop-button add">
            <svg fill="currentColor" class="bi bi-cart-plus-fill" viewBox="0 0 16 16">
          ...
          <p class="random-data">*Se puede envolver para regalo.</p>
        </section>
      </section>
      <section class="product__data-container">
        <figure class="product__politics-container">
          <div class="politic-container">
            <svg fill="currentColor" class="bi bi-shield-lock-fill" viewBox="0 0 16 16">
            ...
            </svg><p class="politics--data">Transacción segura</p>
          </div>
          <div class="politic-container">
            <svg fill="currentColor" class="bi bi-recycle" viewBox="0 0 16 16">
            ...
            </svg><p class="politics--data">Politica de devoluciones</p>
          </div>
          <div class="politic-container">
            <svg fill="currentColor" class="bi bi-robot" viewBox="0 0 16 16">
            ...
            </svg><p class="politics--data">Enviado por Nexus</p>
          </div>
        </figure>
        <h2 class="data__subtitle">Características principales...</h2>
        <table>
          <tr class="tr__line">
            <td class="td__data data--left topL-one">Marca</td>
            <td class="td__data topR-one"><?php echo $marca?></td>
          </tr>
          <tr class="tr__line">
            <td class="td__data data--left">Plataforma</td>
            <td class="td__data"><?php echo $plataforma?></td>
          </tr>
          <tr class="tr__line">
            <td class="td__data data--left botL-one">En stock</td>
            <td class="td__data botR-one">Sí</td>
          </tr>
        </table>
        <section class="product__description-container">
          <h3 class="data__subtitle">Descripción</h3>
          <!-- <ul class="description__list">
            <li class="list--item">La consola Xbox Series S, totalmente digital, ofrece juegos de próxima generación a un precio accesible.</li>
            <li class="list--item">Experimenta la velocidad y el rendimiento de la próxima generación con Xbox Velocity Architecture, impulsada por un SSD personalizado y software integrado.</li>
            <li class="list--item">Juega miles de juegos de cuatro generaciones de Xbox con compatibilidad con versiones anteriores, incluidos títulos optimizados en el lanzamiento.</li>
  ...
  <footer id="support">
    <section class="footer--up">
      <nav>
        <a href="../error/">
          <img src="../../assets/svg/gmail-logo.svg" alt="Gmail de Jackie">Zeira Anceno
        </a>
      ...
      <div class="logo-container">
        <a href="../1/"><img src="../../assets/icons/logo.png" alt="Nexus Store Logo"><p>Nexus 2021 ©</p></a>
      </div>
    </section>
